...
class Proposed_v5(nn.Module):
    def __init__(self, args):

        super(Proposed_v5, self).__init__()
        ...
        # --- Fusion Layer ---
        self.forecasting_model = Forecasting_Model(self.enc_out * 2, self.forecast_hid_dim, self.enc_out, self.forecast_n_layers, self.dropout_fore)
    ...
    def forward(self, x, edge_index=None):
        ...
        # --- Fusion --- #
        fused_output = torch.cat([chan_enc_out, temp_dec_out], dim=-1) # (B, L, 3C)
