...
from layers.layers import ConvLayer, Forecasting_Model, CausalConvLayer
...
class Proposed_v4(nn.Module):
    def __init__(self, args):

        super(Proposed_v4, self).__init__()
        ...
        self.conv = CausalConvLayer(self.enc_in, self.kernel_size)
