...
from layers.layers import Forecasting_Model, series_decomp_zero_padding, ConvLayer
...
class Proposed_v3(nn.Module):
    def __init__(self, args):

        super(Proposed_v3, self).__init__()
        ...
        self.decomp = series_decomp_zero_padding(self.moving_avg_kernel_size)
    ...
    def forward(self, x, edge_index=None):
        ...
        # --- Fusion --- #
        fused_output = torch.cat([temp_dec_out, chan_enc_out, x_t], dim=-1) # (B, L, 3C)
